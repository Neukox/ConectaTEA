        ...
        <div className='space-y-6 pt-4'>
          ...
          <div className='text-center'>
            ...
            <p className='mt-2 text-gray-600'>
              Compartilhe este código ou QR code com o responsável para que ele possa
              vincular a criança <span className='font-semibold'>{nomeCrianca}</span> na plataforma
            </p>
          </div>
          ...
          <div className='rounded-lg border-l-4 border-amber-400 bg-amber-50 p-4'>
            <p className='text-sm text-amber-900'>
              <span className='font-semibold'>⚠️ Importante:</span> Este é o único código para vincular
              o responsável. Guarde este código com segurança e compartilhe apenas com o
              responsável da criança. O código expira em 7 dias.
            </p>
          </div>
          ...
          <div className='space-y-3 rounded-lg bg-blue-50 p-4'>
            ...
            <ol className='space-y-2 list-inside list-decimal text-sm text-blue-900'>
              <li>
                Compartilhe o QR code por WhatsApp, email ou pessoalmente
              </li>
              <li>
                Ou compartilhe apenas o código alfanumérico acima
              </li>
              <li>
                O responsável escaneia o código ou digita após criar sua conta
              </li>
              <li>
                O responsável assina o termo de consentimento LGPD
              </li>
              <li>
