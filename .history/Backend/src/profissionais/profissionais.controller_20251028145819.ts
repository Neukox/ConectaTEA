...
export class ProfissionaisController {
  ...
  @Roles(UserType.PROFISSIONAL, UserType.RESPONSAVEL) // Ambos podem ver a lista de profissionais
  @Get()
  ...
  @ApiBearerAuth()
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles(UserType.PROFISSIONAL) // Só profissionais podem atualizar seus próprios perfis
