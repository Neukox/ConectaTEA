# ConectaTEA - Project Instructions

This file provides guidance to GitHub Copilot on how to assist with the ConectaTEA project. It includes an overview of the project, tech stack, architecture, development commands, and key patterns.
...
- **Notifications**: Custom notification system in [../src/api/barraNotificacao/](../Frontend/src/api/barraNotificacao/)
